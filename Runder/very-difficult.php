...
<html class="nojs html css_verticalspacer" lang="en-US">
 <head>
  ...
  <link rel="stylesheet" type="text/css" href="css/very-difficult.css?crc=3975151491" id="pagesheet"/>
   </head>
 ...
 <body>
  ...
  <div class="clearfix borderbox" id="page"><!-- column -->
   ...
   <div class="clip_frame colelem" id="u354"><!-- image -->
    <img class="block" id="u354_img" src="images/img_0214jpg.jpg?crc=295156765" alt="" data-image-width="66" data-image-height="64"/>
   </div>
...
$sql = "SELECT Name, terrainName, medical, Runs.BackcountryTerrain_idBackcountryTerrain FROM Runs, Terrain WHERE Runs.terrainID = Terrain.terrainID AND Runs.difficulty_rating = 4 AND Runs.MountainId = Terrain.Resort_MountainID";
...
?></p>
   ...
   <div class="verticalspacer" data-offset-top="750" data-content-above-spacer="750" data-content-below-spacer="155"></div>
