...
<html class="nojs html css_verticalspacer" lang="en-US">
 <head>
  ...
  <link rel="stylesheet" type="text/css" href="css/moderate.css?crc=85464285" id="pagesheet"/>
   </head>
 <body>
  ...
  <div class="clearfix borderbox" id="page"><!-- column -->
   ...
   <div class="clip_frame colelem" id="u316"><!-- image -->
    <img class="block" id="u316_img" src="images/img_0216jpg.jpg?crc=4106627174" alt="" data-image-width="66" data-image-height="66"/>
   </div>
...
$sql = "SELECT Name, terrainName, medical, Runs.BackcountryTerrain_idBackcountryTerrain FROM Runs, Terrain WHERE Runs.terrainID = Terrain.terrainID AND Runs.difficulty_rating = 2 AND Runs.MountainId = Terrain.Resort_MountainID";
...
?></p>
   ...
   <div class="verticalspacer" data-offset-top="751" data-content-above-spacer="751" data-content-below-spacer="154"></div>
